...
(function($){if($){function load($widget){$widget.html("Loading...");$widget.pbAjax({type:'GET',url:'/pb/widgets/optimizer',dataType:'html',success:function(data){$widget.closest('.pbOptimizerWidget').replaceWith(data);$('html').trigger("WidgetReinit");},error:function(){$widget.html("");}});}
...
$(function(){var checkout=location.hash.indexOf("checkout")>-1||location.href.indexOf('checkout')>-1;if(checkout&&$(".cartLabel .shopping-cart").html()>0){commerce.page.cart.show();}
